...
class CafeForm(FlaskForm):
    ...
    location_url = StringField(label='URL Location/Google Maps Link', validators=[DataRequired(), URL()])
    ...
    wifi_rating = SelectField("Wifi Strength Rating", choices=["✘", "💪", "💪💪", "💪💪💪", "💪💪💪💪", "💪💪💪💪💪"],
                              validators=[DataRequired()])
    outlets_rating = SelectField("Outlet Availability", choices=["✘", "🔌", "🔌🔌", "🔌🔌🔌", "🔌🔌🔌🔌", "🔌🔌🔌🔌🔌"],
                                 validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        # remember open function, then write in "a" append mode
